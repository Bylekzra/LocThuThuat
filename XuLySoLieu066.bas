...
'Columns("H:I").Copy    'Thêm côt Xóa Côt
...
Call GioMuaDongHe(strx, ww) 'Gio mua dông mua he
...
Cells(ww + 23, 8) = "BS. Dinh Thi Hien"
...
If (date1 <= Sheets("Cacche1").Cells(ww + 1, 5).Value) And (Sheets("Cacche1").Cells(ww + 1, 5).Value < date2) Then
    ...
    Else
        If strx = "So Phau thuat" Then
            Cells(5, 35) = "00:05" 'Step
            Cells(5, 36) = "07:30" 'Gio mua dông
            Cells(5, 37) = "13:00"
            Cells(5, 38) = "mua dông"
        End If
        If strx = "DuLieu" Then
            Cells(4, 35) = "00:05" 'Step
            Cells(4, 36) = "07:30" 'Gio mua dông
            Cells(4, 37) = "13:00"
            Cells(4, 38) = "mua dông"
        End If
End If
...
'Ver:66 Xóa côt 9+10 trong sheets, Thêm BS. Dinh Thi Hien
End Sub
